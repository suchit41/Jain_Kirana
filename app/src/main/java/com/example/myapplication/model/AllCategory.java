...
import com.example.myapplication.Adaptor.AllCategoryAdapter;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.allcombine));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.chai_paati));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.hair_oil));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.fruit));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.allcombine));
